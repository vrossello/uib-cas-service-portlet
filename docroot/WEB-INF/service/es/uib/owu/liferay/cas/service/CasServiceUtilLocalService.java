...
/**
 * Provides the local service interface for CasServiceUtil. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author vrf495
 * @see CasServiceUtilLocalServiceUtil
...
public interface CasServiceUtilLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link CasServiceUtilLocalServiceUtil} to access the cas service util local service. Add custom service methods to {@link es.uib.owu.liferay.cas.service.impl.CasServiceUtilLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
