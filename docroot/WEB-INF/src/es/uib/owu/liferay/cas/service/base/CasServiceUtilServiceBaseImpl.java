...
import es.uib.owu.liferay.cas.service.CasServiceUtilService;
import es.uib.owu.liferay.cas.service.persistence.CasServiceUtilPersistence;

import javax.sql.DataSource;

/**
 * Provides the base implementation for the cas service util remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link es.uib.owu.liferay.cas.service.impl.CasServiceUtilServiceImpl}.
 * </p>
 *
 * @author vrf495
 ...
 * @generated
 */
public abstract class CasServiceUtilServiceBaseImpl extends BaseServiceImpl
	implements CasServiceUtilService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link es.uib.owu.liferay.cas.service.CasServiceUtilServiceUtil} to access the cas service util remote service.
	 */
	...
	private CasServiceUtilServiceClpInvoker _clpInvoker = new CasServiceUtilServiceClpInvoker();
}